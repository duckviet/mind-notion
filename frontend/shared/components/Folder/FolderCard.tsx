      ...
      <ContextMenu>
            ...
            <Card>
              <div className="h-[200px] w-[250px] mb-4 relative pt-6 ">
                ...
                <div className="absolute top-0 left-0 w-full h-full z-0">
                  ...
                  <div className="absolute -top-2 left-0 w-1/2 h-12 bg-surface-elevated rounded-t-3xl rounded-tr-[40px]"></div>
                  {/* Lớp thân folder phía sau (Phần hình chữ nhật bao quanh) */}
                  <div className="absolute top-2 left-0 w-full h-[calc(100%-16px)] bg-surface-elevated rounded-2xl"></div>

                  {notesCount != 0 && (
                    <div className="absolute top-4 left-4 right-4 h-[10%] bg-surface border border-border border-solid  rounded-2xl"></div>
                  )}
                </div>

                {/* Main folder content - Thêm shadow để tách biệt với nền */}
                <div className="bg-surface border border-border border-solid rounded-2xl w-full h-full relative z-10 p-6 flex flex-col justify-between shadow-sm">
                  {/* Folder title */}
        ...
        <ContextMenuContent className="bg-surface border-border shadow-lg">
          <ContextMenuItem
            ...
            className="hover:bg-surface-elevated text-destructive"
          >
